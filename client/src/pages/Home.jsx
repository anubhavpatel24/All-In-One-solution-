...
const services = [
  {
    ...
    imageSrc: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=1200&q=80',
    accent: '#23408E',
    badge: 'Trending',
  },
  {
    ...
    imageSrc: 'https://images.unsplash.com/photo-1535141192574-5d4897c12636?auto=format&fit=crop&w=1200&q=80',
    accent: '#8D3D24',
    badge: 'Fresh bake',
  },
  {
  ...
  return (
    <>
      ...
      <section id="services" className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:py-14 lg:px-8">
        ...
        <div className="rounded-[2rem] border border-slate-200 bg-gradient-to-b from-white to-slate-50 p-4 shadow-sm sm:p-5">
